 ...
 * This file demonstrates how to integrate Cryptosign with a web frontend
 */

// For React/Vue/Angular applications
export class CryptosignClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CryptosignClient(provider, contractAddress);
